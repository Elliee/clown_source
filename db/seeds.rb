...
booking = Booking.create(start_date: "3122021", end_date: "5122021", user_id: user.id, clown_id: 1)
booking.save!
puts "booking with id: #{booking.id} has been created"
Booking.create(start_date: "4122021", end_date: "8122021", user_id: 1, clown_id: 2)
Booking.create(start_date: "5122021", end_date: "10122021", user_id: 1, clown_id: 3)
